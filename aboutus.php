<html>
  ...
  <body>
	...
	<div class="col-md-3">
        ...
        <div class="col-md-3">
            <div class="card p-2 py-3 text-center">
                <div class="img mb-2"> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ-2fZoMIz9ZgrhdRrgLSV9XFXfncNHtlV3oQ&usqp=CAU.jpg" width="130" class="rounded-circle"> </div>
                <h5 class="mb-0">Anna Maul</h5> <small>Cross-Fit Trainer</small>
            </div>
        </div>
		<div class="col-md-3">
            <div class="card p-2 py-3 text-center">
